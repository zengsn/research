...
1. **S. Zeng**, B. Zhang and Y. Du, Joint Distances by Sparse Representation and Locality-Constrained Dictionary Learning for Robust Leaf Recognition, *Computers and Electronics in Agriculture* (2017). 142(B):563-571[Online, [Code](https://github.com/zengsn/research/tree/master/2017-compag-srdl-leaf), [Paper](https://www.sciencedirect.com/science/article/pii/S0168169917310876)]
2. H. Ma, J. Gou, X. Wang, J. Ke, **S. Zeng**, Sparse coefficient-based k-nearest neighbor classification, *IEEE Access* (2017) 5:16618-16634. doi:10.1016/j.compag.2017.11.013. [[Paper](http://ieeexplore.ieee.org/document/8010421/)]
