...
1. **S. Zeng**, **B. Zhang***, Y. Zhang and J. Gou, Dual Sparse Learning via Data Augmentation for Robust Facial Image Classification. *International Journal of Machine Learning and Cybernetics* (2020). Accepted. [SCI, IF=3.844]
2. Q. Zhang, J. Zhou, J. He, X. Cun, **S. Zeng**, and **B. Zhang***. A shell dataset, for shell features extraction and recognition. *Scientific Data* (2019), 6(1): 1-9. [SCI, IF=5.929] ([Welcome to use the Shell dataset.](https://github.com/zqplus/shell-recognition/), and the paper - https://www.nature.com/articles/s41597-019-0230-3)
3. **S. Zeng**, **B. Zhang***, Y. Lan and J. Gou, Robust Collaborative Representation based Classification via Regularization of Truncated Total Least Squares, *Neural Computing & Applications* (2019), 31(10):5689-5697. [SCI, IF=4.664, [Code](https://github.com/zengsn/pub-2018-ncaa-tcrc), Paper [(DOI)](https://doi.org/10.1007/s00521-018-3403-7)]
