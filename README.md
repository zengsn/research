...
1. **S. Zeng**, B. Zhang*, Y. Zhang and J. Gou, Collaboratively Weighting Deep and Classic Representation via $l_2$ Regularization for Image Classification, **To be presented** in *The 10th Asian Conference on Machine Learning, Beijing ([ACML 2018](http://www.acml-conf.org/2018/))*. [[Code](https://github.com/zengsn/pub-2018-acml-deepcwc), Pre-printed [arXiv:1802.07589](https://arxiv.org/abs/1802.07589), Formal (coming soon)]
